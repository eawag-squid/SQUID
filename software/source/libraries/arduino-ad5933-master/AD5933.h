...
#define VOUT_RANGE_1     (CTRL_VOUT_RANGE_1)
#define VOUT_RANGE_2     (CTRL_VOUT_RANGE_2)
#define VOUT_RANGE_3     (CTRL_VOUT_RANGE_3)
#define VOUT_RANGE_4     (CTRL_VOUT_RANGE_4)
// Power modes
...
#define CTRL_VOUT_RANGE_1		(0b00000000) //2Vpp - typical
#define CTRL_VOUT_RANGE_2		(0b00000110) //1Vpp 
#define CTRL_VOUT_RANGE_3		(0b00000100) //0.4Vpp
#define CTRL_VOUT_RANGE_4		(0b00000010) //0.2Vpp 
